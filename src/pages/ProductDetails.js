...
import {getProduct} from "../sevices";
            ...
            <section>
                ...
                <Rating rating={product.rating}/>
                        ...
                        <p className="my-4 select-none">
                            ...
                            <span
                                className="font-semibold text-blue-500 border bg-slate-100 rounded-lg px-3 py-1 mr-2">{product.size} MB</span>
                        </p>
                        <p className="my-3">
                            {!inCart && product.in_stock && <button onClick={() => addToCart(product)}
                            ...
                            {inCart && <button onClick={() => removeFromCart(product)} className={`inline-flex items-center 
                            py-2 px-5 text-lg font-medium text-center 
                             text-white bg-red-600 rounded-lg hover:bg-red-800`}
                                               disabled={product.in_stock ? "" : "disabled"}>Remove Item <i
                                className="ml-1 bi bi-trash3"></i>
                            </button>}
                        </p>
