            ...
            <form onSubmit={handleRegister}>
                <div className="mb-6">
                    ...
                    <input type="name" id="name"
                           ...
                           placeholder="Shubham Sarda" required autoComplete="off"/>
                </div>
                <div className="mb-6">
                    ...
                    <input type="email" id="email"
                           ...
                           dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500
                           dark:focus:border-blue-500 dark:shadow-sm-light"
                           placeholder="shubham@example.com" required autoComplete="off"/>
                </div>
                <div className="mb-6">
                ...
                <button type="submit"
                        ...
                        dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register
                </button>
            </form>
        </main>
    )
