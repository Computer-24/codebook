        ...
        <div
            ...
            <div className="p-5">
                ...
                <span className="text-2xl dark:text-gray-200">
                    ...
                    {!inCart && product.in_stock && <button
                        className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white
                        bg-blue-700 rounded-lg hover:bg-blue-800" onClick={() => handleAddToCart(product)}>Add to cart
                    </button>}
                    {inCart && <button className="inline-flex items-center py-2 px-3 text-sm font-medium text-center
                        text-white bg-red-600 rounded-lg hover:bg-red-800" onClick={() => handleRemoveFromCart(product)}>Remove Item
